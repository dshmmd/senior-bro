  ...
  return (
    <>
        ...
        <div className="row" style={{ justifyContent: 'space-between' }}>
          <div>
            ...
            <span className={`badge ${report.level_estimate}`}>
              {report.level_estimate} level performance
            </span>
          </div>
        </div>
        <div className="mt">
      ...
      {report.weaknesses.length > 0 && (
        <div className="card">
          <b>🎯 Weaknesses to work on</b>{' '}
          <span style={{ color: 'var(--muted)', fontSize: 13 }}>(saved — drill them from the dashboard)</span>
